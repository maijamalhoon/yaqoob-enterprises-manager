...
import { Search, Receipt, HelpCircle, LockKeyhole } from "lucide-react";
    ...
    <header className="h-16 border-b border-[#e6e8ec] bg-white/95 backdrop-blur-md px-6 flex items-center justify-between z-30 select-none shrink-0">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-lg text-[#555f73] transition-colors hover:bg-[#f2f4f6] hover:text-[#191c1e]"
        >
